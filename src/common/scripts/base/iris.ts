...
import { GeetestCaptcha, CmTencentCaptcha, DisableCaptcha } from '@frontend/iris/dist/types/src/modules/captcha';
import { EnvName } from '@frontend/iris/dist/types/config';
